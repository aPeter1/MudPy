...
int TRI_readHdr( FILE* fin, TMF_F_HDR * pTmf_f_hdr );
int TRI_readHistHdr( FILE* fin, TMF_H_RECD* pTmf_h_recd );
    ...
    MUD_SEC_GRP* pMUD_histGrp;
{
	...
	/*
	 *  Skip over either junk or spike data after hist; bring pointer to next hist
	 */
	num = fread( buf, 448-size%512, 1, fin );
