...
/* mud_friendly.c */
MUD_API int MUD_openRead _ANSI_ARGS_((char* filename, UINT32* pType));
MUD_API int MUD_openWrite _ANSI_ARGS_((char* filename, UINT32 type));
MUD_API int MUD_openReadWrite _ANSI_ARGS_((char* filename, UINT32* pType));
MUD_API int MUD_closeRead _ANSI_ARGS_((int fd));
MUD_API int MUD_closeWrite _ANSI_ARGS_((int fd));
MUD_API int MUD_closeWriteFile _ANSI_ARGS_((int fd, char* outfile));

MUD_API int MUD_getRunDesc _ANSI_ARGS_((int fd, UINT32* pType));
MUD_API int MUD_getExptNumber _ANSI_ARGS_((int fd, UINT32* pExptNumber));
MUD_API int MUD_getRunNumber _ANSI_ARGS_((int fd, UINT32* pRunNumber));
MUD_API int MUD_getElapsedSec _ANSI_ARGS_((int fd, UINT32* pElapsedSec));
MUD_API int MUD_getTimeBegin _ANSI_ARGS_((int fd, UINT32* TimeBegin));
MUD_API int MUD_getTimeEnd _ANSI_ARGS_((int fd, UINT32* TimeEnd));
MUD_API int MUD_getTitle _ANSI_ARGS_((int fd, char* title, int strdim));
MUD_API int MUD_getLab _ANSI_ARGS_((int fd, char* lab, int strdim));
MUD_API int MUD_getArea _ANSI_ARGS_((int fd, char* area, int strdim));
MUD_API int MUD_getMethod _ANSI_ARGS_((int fd, char* method, int strdim));
MUD_API int MUD_getApparatus _ANSI_ARGS_((int fd, char* apparatus, int strdim));
MUD_API int MUD_getInsert _ANSI_ARGS_((int fd, char* insert, int strdim));
MUD_API int MUD_getSample _ANSI_ARGS_((int fd, char* sample, int strdim));
MUD_API int MUD_getOrient _ANSI_ARGS_((int fd, char* orient, int strdim));
MUD_API int MUD_getDas _ANSI_ARGS_((int fd, char* das, int strdim));
MUD_API int MUD_getExperimenter _ANSI_ARGS_((int fd, char* experimenter, int strdim));
MUD_API int MUD_getTemperature _ANSI_ARGS_((int fd, char* temperature, int strdim));
MUD_API int MUD_getField _ANSI_ARGS_((int fd, char* field, int strdim));
MUD_API int MUD_getSubtitle _ANSI_ARGS_((int fd, char* subtitle, int strdim));
MUD_API int MUD_getComment1 _ANSI_ARGS_((int fd, char* comment1, int strdim));
MUD_API int MUD_getComment2 _ANSI_ARGS_((int fd, char* comment2, int strdim));
MUD_API int MUD_getComment3 _ANSI_ARGS_((int fd, char* comment3, int strdim));

MUD_API int MUD_setRunDesc _ANSI_ARGS_((int fd, UINT32 type));
MUD_API int MUD_setExptNumber _ANSI_ARGS_((int fd, UINT32 exptNumber));
MUD_API int MUD_setRunNumber _ANSI_ARGS_((int fd, UINT32 runNumber));
MUD_API int MUD_setElapsedSec _ANSI_ARGS_((int fd, UINT32 elapsedSec));
MUD_API int MUD_setTimeBegin _ANSI_ARGS_((int fd, UINT32 timeBegin));
MUD_API int MUD_setTimeEnd _ANSI_ARGS_((int fd, UINT32 timeEnd));
MUD_API int MUD_setTitle _ANSI_ARGS_((int fd, char* title));
MUD_API int MUD_setLab _ANSI_ARGS_((int fd, char* lab));
MUD_API int MUD_setArea _ANSI_ARGS_((int fd, char* area));
MUD_API int MUD_setMethod _ANSI_ARGS_((int fd, char* method));
MUD_API int MUD_setApparatus _ANSI_ARGS_((int fd, char* apparatus));
MUD_API int MUD_setInsert _ANSI_ARGS_((int fd, char* insert));
MUD_API int MUD_setSample _ANSI_ARGS_((int fd, char* sample));
MUD_API int MUD_setOrient _ANSI_ARGS_((int fd, char* orient));
MUD_API int MUD_setDas _ANSI_ARGS_((int fd, char* das));
MUD_API int MUD_setExperimenter _ANSI_ARGS_((int fd, char* experimenter));
MUD_API int MUD_setTemperature _ANSI_ARGS_((int fd, char* temperature));
MUD_API int MUD_setField _ANSI_ARGS_((int fd, char* field));
MUD_API int MUD_setSubtitle _ANSI_ARGS_((int fd, char* subtitle));
MUD_API int MUD_setComment1 _ANSI_ARGS_((int fd, char* comment1));
MUD_API int MUD_setComment2 _ANSI_ARGS_((int fd, char* comment2));
MUD_API int MUD_setComment3 _ANSI_ARGS_((int fd, char* comment3));

MUD_API int MUD_getComments _ANSI_ARGS_((int fd, UINT32* pType, UINT32* pNum));
MUD_API int MUD_getCommentPrev _ANSI_ARGS_((int fd, int num, UINT32* pPrev));
MUD_API int MUD_getCommentNext _ANSI_ARGS_((int fd, int num, UINT32* pNext));
MUD_API int MUD_getCommentTime _ANSI_ARGS_((int fd, int num, UINT32* pTime));
MUD_API int MUD_getCommentAuthor _ANSI_ARGS_((int fd, int num, char* author, int strdim));
MUD_API int MUD_getCommentTitle _ANSI_ARGS_((int fd, int num, char* title, int strdim));
MUD_API int MUD_getCommentBody _ANSI_ARGS_((int fd, int num, char* body, int strdim));

MUD_API int MUD_setComments _ANSI_ARGS_((int fd, UINT32 type, UINT32 num));
MUD_API int MUD_setCommentPrev _ANSI_ARGS_((int fd, int num, UINT32 prev));
MUD_API int MUD_setCommentNext _ANSI_ARGS_((int fd, int num, UINT32 next));
MUD_API int MUD_setCommentTime _ANSI_ARGS_((int fd, int num, UINT32 time));
MUD_API int MUD_setCommentAuthor _ANSI_ARGS_((int fd, int num, char* author));
MUD_API int MUD_setCommentTitle _ANSI_ARGS_((int fd, int num, char* title));
MUD_API int MUD_setCommentBody _ANSI_ARGS_((int fd, int num, char* body));

MUD_API int MUD_getHists _ANSI_ARGS_((int fd, UINT32* pType, UINT32* pNum));
MUD_API int MUD_getHistType _ANSI_ARGS_((int fd, int num, UINT32* pType));
MUD_API int MUD_getHistNumBytes _ANSI_ARGS_((int fd, int num, UINT32* pNumBytes));
MUD_API int MUD_getHistNumBins _ANSI_ARGS_((int fd, int num, UINT32* pNumBins));
MUD_API int MUD_getHistBytesPerBin _ANSI_ARGS_((int fd, int num, UINT32* pBytesPerBin));
MUD_API int MUD_getHistFsPerBin _ANSI_ARGS_((int fd, int num, UINT32* pFsPerBin));
MUD_API int MUD_getHistSecondsPerBin _ANSI_ARGS_((int fd, int num, REAL64* pSecondsPerBin));
MUD_API int MUD_getHistT0_Ps _ANSI_ARGS_((int fd, int num, UINT32* pT0_ps));
MUD_API int MUD_getHistT0_Bin _ANSI_ARGS_((int fd, int num, UINT32* pT0_bin));
MUD_API int MUD_getHistGoodBin1 _ANSI_ARGS_((int fd, int num, UINT32* pGoodBin1));
MUD_API int MUD_getHistGoodBin2 _ANSI_ARGS_((int fd, int num, UINT32* pGoodBin2));
MUD_API int MUD_getHistBkgd1 _ANSI_ARGS_((int fd, int num, UINT32* pBkgd1));
MUD_API int MUD_getHistBkgd2 _ANSI_ARGS_((int fd, int num, UINT32* pBkgd2));
...
MUD_API int MUD_setHistNumBytes _ANSI_ARGS_((int fd, int num, UINT32 numBytes));
MUD_API int MUD_setHistNumBins _ANSI_ARGS_((int fd, int num, UINT32 numBins));
MUD_API int MUD_setHistBytesPerBin _ANSI_ARGS_((int fd, int num, UINT32 bytesPerBin));
MUD_API int MUD_setHistFsPerBin _ANSI_ARGS_((int fd, int num, UINT32 fsPerBin));
MUD_API int MUD_setHistSecondsPerBin _ANSI_ARGS_((int fd, int num, REAL64 secondsPerBin));
MUD_API int MUD_setHistT0_Ps _ANSI_ARGS_((int fd, int num, UINT32 t0_ps));
MUD_API int MUD_setHistT0_Bin _ANSI_ARGS_((int fd, int num, UINT32 t0_bin));
MUD_API int MUD_setHistGoodBin1 _ANSI_ARGS_((int fd, int num, UINT32 goodBin1));
MUD_API int MUD_setHistGoodBin2 _ANSI_ARGS_((int fd, int num, UINT32 goodBin2));
MUD_API int MUD_setHistBkgd1 _ANSI_ARGS_((int fd, int num, UINT32 bkgd1));
MUD_API int MUD_setHistBkgd2 _ANSI_ARGS_((int fd, int num, UINT32 bkgd2));
MUD_API int MUD_setHistNumEvents _ANSI_ARGS_((int fd, int num, UINT32 numEvents));
MUD_API int MUD_setHistTitle _ANSI_ARGS_((int fd, int num, char* title));
MUD_API int MUD_setHistData _ANSI_ARGS_((int fd, int num, void* pData));
MUD_API int MUD_setHistpData _ANSI_ARGS_((int fd, int num, void* pData));
MUD_API int MUD_setHistTimeData _ANSI_ARGS_((int fd, int num, UINT32* pTimeData));
MUD_API int MUD_setHistpTimeData _ANSI_ARGS_((int fd, int num, UINT32* pTimeData));

MUD_API int MUD_pack _ANSI_ARGS_((int num, int inBinSize, void* inArray, int outBinSize, void* outArray));
MUD_API int MUD_unpack _ANSI_ARGS_((int num, int inBinSize, void* inArray, int outBinSize, void* outArray));

MUD_API int MUD_getScalers _ANSI_ARGS_((int fd, UINT32* pType, UINT32* pNum));
MUD_API int MUD_getScalerLabel _ANSI_ARGS_((int fd, int num, char* label, int strdim));
MUD_API int MUD_getScalerCounts _ANSI_ARGS_((int fd, int num, UINT32* pCounts));

MUD_API int MUD_setScalers _ANSI_ARGS_((int fd, UINT32 type, UINT32 num));
MUD_API int MUD_setScalerLabel _ANSI_ARGS_((int fd, int num, char* label));
MUD_API int MUD_setScalerCounts _ANSI_ARGS_((int fd, int num, UINT32* pCounts));

MUD_API int MUD_getIndVars _ANSI_ARGS_((int fd, UINT32* pType, UINT32* pNum));
MUD_API int MUD_getIndVarLow _ANSI_ARGS_((int fd, int num, double* pLow));
MUD_API int MUD_getIndVarHigh _ANSI_ARGS_((int fd, int num, double* pHigh));
MUD_API int MUD_getIndVarMean _ANSI_ARGS_((int fd, int num, double* pMean));
MUD_API int MUD_getIndVarStddev _ANSI_ARGS_((int fd, int num, double* pStddev));
MUD_API int MUD_getIndVarSkewness _ANSI_ARGS_((int fd, int num, double* pSkewness));
MUD_API int MUD_getIndVarName _ANSI_ARGS_((int fd, int num, char* name, int strdim));
MUD_API int MUD_getIndVarDescription _ANSI_ARGS_((int fd, int num, char* description, int strdim));
MUD_API int MUD_getIndVarUnits _ANSI_ARGS_((int fd, int num, char* units, int strdim));
MUD_API int MUD_getIndVarNumData _ANSI_ARGS_((int fd, int num, UINT32* pNumData));
MUD_API int MUD_getIndVarElemSize _ANSI_ARGS_((int fd, int num, UINT32* pElemSize));
MUD_API int MUD_getIndVarDataType _ANSI_ARGS_((int fd, int num, UINT32* pDataType));
...
MUD_API int MUD_setIndVarHigh _ANSI_ARGS_((int fd, int num, double high));
MUD_API int MUD_setIndVarMean _ANSI_ARGS_((int fd, int num, double mean));
MUD_API int MUD_setIndVarStddev _ANSI_ARGS_((int fd, int num, double stddev));
MUD_API int MUD_setIndVarSkewness _ANSI_ARGS_((int fd, int num, double skewness));
MUD_API int MUD_setIndVarName _ANSI_ARGS_((int fd, int num, char* name));
MUD_API int MUD_setIndVarDescription _ANSI_ARGS_((int fd, int num, char* description));
MUD_API int MUD_setIndVarUnits _ANSI_ARGS_((int fd, int num, char* units));
MUD_API int MUD_setIndVarNumData _ANSI_ARGS_((int fd, int num, UINT32 numData));
MUD_API int MUD_setIndVarElemSize _ANSI_ARGS_((int fd, int num, UINT32 elemSize));
MUD_API int MUD_setIndVarDataType _ANSI_ARGS_((int fd, int num, UINT32 dataType));
MUD_API int MUD_setIndVarHasTime _ANSI_ARGS_((int fd, int num, UINT32 hasTime));
MUD_API int MUD_setIndVarData _ANSI_ARGS_((int fd, int num, void* pData));
MUD_API int MUD_setIndVarTimeData _ANSI_ARGS_((int fd, int num, UINT32* pTimeData));
MUD_API int MUD_setIndVarpData _ANSI_ARGS_((int fd, int num, void* pData));
MUD_API int MUD_setIndVarpTimeData _ANSI_ARGS_((int fd, int num, UINT32* pTimeData));
